...
public class PlatformHController : MonoBehaviour {
	...
	IEnumerator Start () {
	 pointA = new Vector2(platform.transform.position.x + offset + offset,platform.transform.position.y);
	 pointB = new Vector2(platform.transform.position.x - offset - offset,platform.transform.position.y);
	 while(true)
	 {
